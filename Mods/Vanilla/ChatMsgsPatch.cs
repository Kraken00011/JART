...
public class ChatMessagesPatch : ILoadable
{
    ...
    private void On_RemadeChatMonitorOnAddNewMessage(On_RemadeChatMonitor.orig_AddNewMessage orig, RemadeChatMonitor self, string text, Color color, int widthlimitinpixels)
    {
        ...
        text = text switch
        {
            ...
            => "ПРЕДУПРЕЖДЕНИЕ О СВЕТОЧУВСТВИТЕЛЬНОСТИ: Spirit Classic Bosses Rework добавляет множество мигающих эффектов и резких вспышек! Особенно во время битв с боссами!\nЕсли для вас это проблематично, перейдите в Настройки → Конфигурация модов → Spirit Classic Bosses Rework → Клиентская конфигурация и выставьте все ползунки на 0!\nВы также можете отключить это предупреждение в той же конфигурации.",
            // Accessory Hearts
            "The Heart deemed you as unworthy..." => "Сердце сочло вас недостойным...",
            _ => text
        };
