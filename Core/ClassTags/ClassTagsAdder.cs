...
namespace JAtRT.Core.ClassTags
{
    public static class ClassTagsAdder
    {
        ...
        static ClassTagsAdder()
        {
            ...
            {
                ("MulticlassTag", Language.GetTextValue("Mods.JAtRT.Tags.Class.Multiclass"), new Color(55, 182, 206)),
                ("ClasslessTag", Language.GetTextValue("Mods.JAtRT.Tags.Class.Classless"), new Color(255, 255, 255)),
                ("FishingTag", Language.GetTextValue("Mods.JAtRT.Tags.Special.Fishing"), new Color(102, 255, 255)),
                ("MovementTag", Language.GetTextValue("Mods.JAtRT.Tags.Special.Movement"), new Color(144, 238, 144)),
                ("SurvivabilityTag", Language.GetTextValue("Mods.JAtRT.Tags.Special.Survivability"), new Color(220, 20, 60)),
                ("ToolTag", Language.GetTextValue("Mods.JAtRT.Tags.Special.Tool"), new Color(224, 255, 255)),
                ("MiningTag", Language.GetTextValue("Mods.JAtRT.Tags.Special.Mining"), new Color(224, 255, 255)),
            };
